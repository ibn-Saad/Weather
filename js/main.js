...
//     `http://api.weatherapi.com/v1/forecast.json?key=7fba3e875b824190b3b113240240601&q=${city}&days=3`
//   );
...
function getTomorrow(data) {
  document.querySelector(".tIcon").src =
    data.forecast.forecastday[1].day.condition.icon;
  document.querySelector(".tMaxTemp").innerHTML =
    data.forecast.forecastday[1].day.maxtemp_c + "°C";
  document.querySelector(".tMinTemp").innerHTML =
    data.forecast.forecastday[1].day.mintemp_c + "°C";
  document.querySelector(".tCond").innerHTML =
    data.forecast.forecastday[1].day.condition.text;
}

function getAfterTomorrow(data) {
  document.querySelector(".atIcon").src =
    data.forecast.forecastday[2].day.condition.icon;
  document.querySelector(".atMaxTemp").innerHTML =
    data.forecast.forecastday[2].day.maxtemp_c + "°C";
  document.querySelector(".atMinTemp").innerHTML =
    data.forecast.forecastday[2].day.mintemp_c + "°C";
  document.querySelector(".atCond").innerHTML =
